...
def payments_page():
    ...
    amount = st.number_input("Amount to Pay", min_value=0.0, step=0.01)
...
def main():
    ...
    pages = {"Login / Sign Up": login_signup, "Book Taxi": book_taxi, "Contact Us": contact_us, "Payments": payments_page}
