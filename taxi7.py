# Triad Taxi Bookings website by Group 2 CST 499
...
def send_email(name, email, message):
    try:
        ...
        message = Mail(
            ...
            subject='Message from Taxi Cancellations App',
...
st.set_page_config(page_title="Triad Taxi Bookings", page_icon=":taxi:", layout="wide")  # Set the page title and background image here
set_background(r"C:\Users\tmein\Downloads\taxi\background.png")

# Main function to run the app
def main():
    st.sidebar.title("Navigation")
    pages = {"Login / Sign Up": login_signup, "Book Taxi": book_taxi, "Contact Us": contact_us}
